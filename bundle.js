...
function connection(r, obj1, obj2, line, bg) {
    ...
    if (line && line.line) {
        ...
        return {
            bg: bg && bg.split && r.path(path).attr({stroke: bg.split("|")[0], fill: "none", "stroke-width": bg.split("|")[1] || 3}),
            line: r.path(path).attr({stroke: color, fill: "none"}),
            from: obj1,
            to: obj2
        };
    }
